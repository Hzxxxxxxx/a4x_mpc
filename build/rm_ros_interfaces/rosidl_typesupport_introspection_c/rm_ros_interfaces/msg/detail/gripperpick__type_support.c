...
static rosidl_typesupport_introspection_c__MessageMember rm_ros_interfaces__msg__Gripperpick__rosidl_typesupport_introspection_c__Gripperpick_message_member_array[3] = {
  {
    "speed",  // name
