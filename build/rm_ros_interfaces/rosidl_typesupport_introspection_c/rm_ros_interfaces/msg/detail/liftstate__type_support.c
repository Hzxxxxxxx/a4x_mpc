...
static rosidl_typesupport_introspection_c__MessageMember rm_ros_interfaces__msg__Liftstate__rosidl_typesupport_introspection_c__Liftstate_message_member_array[3] = {
  {
    "height",  // name
